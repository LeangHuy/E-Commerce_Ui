...
export default function DashboadComponent({ children }) {
  ...
  return (
    <div>
      ...
      <aside
        id="default-sidebar "
        className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 mt-20"
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-[#ddbeaa]">
          <ul className="space-y-2 font-medium">
            ...
            <li>
              <a
                href="#"
                className="flex items-center p-2 text-[#ffff] hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
                  className="flex-shrink-0 w-5 h-5 text-[#ffff] transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 18 18"
                ...
                <span className="flex-1 ms-3 whitespace-nowrap">Analytic</span>
              </a>
            </li>
            <li>
              <a
