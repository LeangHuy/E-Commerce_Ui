...
const RestockProduct = ({ product }) => {
    const onSubmit = async (data) => {
        const result = await restockProductAction(data, product?.productId);
        if (result?.productId) {
        ...
        <div>
            <Dialog>
                ...
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        <DialogTitle>Restock for <span className="text-sky-400">{product?.productName}</span></DialogTitle>
                        <DialogDescription>
                        ...
                        <div className="">
                            ...
                            <div className="mt-2">
                                <div className="flex rounded-md shadow-sm ring-inset ring-gray-300  sm:max-w-md">
                                    <input
                                        {...register("newStock", { required: true, valueAsNumber: true, })}
                                        type="number"
